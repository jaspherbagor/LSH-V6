                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="pt_10 pb_10">
                                            ...
                                            <a href="{{ route('accommodation_review_delete', $row->id) }}" class="btn btn-danger mb-1" onClick="return confirm('Are you sure you want to delete this review?');" data-toggle="tooltip" data-placement="top" title="Delete"><i class="fa fa-trash" aria-hidden="true"></i></a>
                                        </td>
