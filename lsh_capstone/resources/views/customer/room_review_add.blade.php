...
@section('heading', 'Add Review for '.$room_info->room_name . ' ('.$accommodation_info->name.')')

@section('right_top_button')
<a href="{{ route('customer_room_review_view') }}" class="btn btn-primary"><i class="fa fa-eye"></i> View All</a>
@endsection
