...
class AdminHomeController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('admin.home', compact('total_completed_orders', 'total_pending_orders', 'total_active_customers', 'total_pending_customers', 'total_accommodations', 'total_subscribers', 'recent_orders', 'total_pending_accommodations', 'total_approved_accommodations'));
    }
}
