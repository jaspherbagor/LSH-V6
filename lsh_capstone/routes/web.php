...
Route::middleware('guest')->group(function () {
    ...
    Route::post('/accommodation/register-submit', [AccommodationAuthController::class, 'register_submit'])->name('accommodation_register_submit');
...
Route::group(['middleware' => ['customer:customer']], function() {
    ...
    Route::get('/customer/declined-order/view', [CustomerOrderController::class, 'declined_order'])->name('customer_declined_order_view');
...
Route::group(['middleware' => ['admin:admin']], function() {
    ...
    Route::get('/admin/completed-order/view', [AdminOrderController::class, 'completed_order'])->name('admin_completed_order_view');

    Route::get('/admin/declined-order/view', [AdminOrderController::class, 'declined_order'])->name('admin_declined_order_view');
    ...
    Route::post('/admin/transaction/report/receipt', [AdminOrderController::class, 'report_receipt'])->name('report_receipt');
